/*
 * \brief  Serial output driver specific for the i.MX6
...
#ifndef _INCLUDE__PLATFORM__IMX6__DRIVERS__SERIAL_LOG_H_
#define _INCLUDE__PLATFORM__IMX6__DRIVERS__SERIAL_LOG_H_
...
#endif /* _INCLUDE__PLATFORM__IMX6__DRIVERS__SERIAL_LOG_H_ */
