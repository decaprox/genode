...
static void omap_ehci_init()
{
	...
	gpio.set_direction_output(HUB_POWER, false);
	gpio.set_direction_output(HUB_NRESET, false);
    gpio.set_dataout(HUB_POWER, 0);
    gpio.set_dataout(HUB_NRESET, 1);
